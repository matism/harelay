                        ...
                        <div class="mt-6 space-y-6">
                            ...
                            <div>
                                ...
                                <div class="mt-1 flex items-center">
                                    <input type="text" readonly value="{{ $connection->subdomain }}.harelay.io" class="block w-full rounded-md border-gray-300 bg-gray-50 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
                                    <button onclick="navigator.clipboard.writeText('{{ $connection->subdomain }}.harelay.io')" class="ml-2 inline-flex items-center px-3 py-2 border border-gray-300 shadow-sm text-sm leading-4 font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                                        Copy
                                    </button>
                                </div>
                            </div>
