        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-6 grid grid-cols-1 sm:grid-cols-3 gap-4">
                <a href="{{ route('dashboard.setup') }}" class="bg-white/5 hover:bg-white/10 backdrop-blur-lg overflow-hidden shadow-lg rounded-xl border border-white/10 hover:border-white/20 transition p-5 flex items-center">
                    <div class="w-12 h-12 rounded-lg bg-cyan-500/20 flex items-center justify-center mr-4 flex-shrink-0">
                ...
                <a href="{{ route('dashboard.settings') }}#mobile-app" class="bg-white/5 hover:bg-white/10 backdrop-blur-lg overflow-hidden shadow-lg rounded-xl border border-white/10 hover:border-white/20 transition p-5 flex items-center">
                    <div class="w-12 h-12 rounded-lg bg-purple-500/20 flex items-center justify-center mr-4 flex-shrink-0">
                    ...
                    <div class="min-w-0">
                        ...
                        <p class="text-slate-400 text-sm">Get link for HA app</p>
                    </div>
                </a>
