    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
                <a href="{{ route('dashboard.setup') }}" class="bg-white/5 hover:bg-white/10 backdrop-blur-lg overflow-hidden shadow-lg sm:rounded-xl border border-white/10 hover:border-white/20 transition p-5 flex items-center">
                ...
                <a href="{{ route('dashboard.settings') }}" class="bg-white/5 hover:bg-white/10 backdrop-blur-lg overflow-hidden shadow-lg sm:rounded-xl border border-white/10 hover:border-white/20 transition p-5 flex items-center">
                    <div class="w-12 h-12 rounded-lg bg-cyan-500/20 flex items-center justify-center mr-4">
                        <svg class="w-6 h-6 text-cyan-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
