                ...
                <main class="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                    <div class="sm:text-center lg:text-left">
                        <h1 class="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                            ...
                            <span class="block text-blue-600">Home Assistant</span>
                            <span class="block">from anywhere</span>
                        </h1>
                        <p class="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                            Secure remote access without port forwarding. Install our simple add-on and connect to your home in seconds.
                        </p>
                        <div class="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                            ...
                            <div class="mt-3 sm:mt-0 sm:ml-3">
                                <a href="{{ route('marketing.how-it-works') }}" class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-blue-700 bg-blue-100 hover:bg-blue-200 md:py-4 md:text-lg md:px-10">
                                    Learn More
                                </a>
                            </div>
                        </div>
        ...
        <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
            <div class="h-56 w-full bg-gradient-to-br from-blue-400 to-blue-600 sm:h-72 md:h-96 lg:w-full lg:h-full flex items-center justify-center">
                <div class="text-white text-center p-8">
                    ...
                    <p class="text-xl font-semibold">Your Home, Anywhere</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="mt-16">
                <div class="grid grid-cols-1 gap-8 md:grid-cols-3">
                    ...
                    <div class="bg-white rounded-lg shadow-sm p-8">
                        ...
                        <h3 class="mt-6 text-lg font-medium text-gray-900">Secure by Design</h3>
                    ...
                    <div class="bg-white rounded-lg shadow-sm p-8">
                        ...
                        <h3 class="mt-6 text-lg font-medium text-gray-900">Instant Setup</h3>
                        <p class="mt-2 text-gray-500">
                            Install our Home Assistant add-on, enter your token, and you're connected. No complex configuration needed.
                        </p>
                    </div>
