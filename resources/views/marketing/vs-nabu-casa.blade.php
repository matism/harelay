<x-marketing-layout>
    ...
    <x-slot name="structuredData">
        <script type="application/ld+json">
        {
            ...
            "@@type": "WebPage",
            "name": "Nabu Casa vs HARelay - Free Home Assistant Remote Access Alternative",
            "description": "Compare HARelay and Nabu Casa for Home Assistant remote access. HARelay offers free, simple remote access without monthly subscriptions.",
            "url": "{{ url()->current() }}",
            "mainEntity": {
                "@@type": "ItemList",
                ...
                "itemListElement": [
                    ...
                    },
                    {
                        ...
                        "position": 2,
                        "name": "Nabu Casa",
                        "description": "Official Home Assistant remote access service with monthly subscription that supports HA development."
                    }
                ]
            }
        }
                    ...
                    <div class="relative bg-gradient-to-b from-white/10 to-white/5 backdrop-blur-lg rounded-3xl border border-white/20 p-8 flex flex-col w-full">
                        ...
                        <ul class="space-y-4 flex-grow">
                            <li class="flex items-start">
                                ...
                                <span class="text-slate-300">You want <strong class="text-white">free remote access</strong> without monthly fees</span>
                            </li>
                            <li class="flex items-start">
                                <svg class="w-5 h-5 text-cyan-400 mt-0.5 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                </svg>
                                <span class="text-slate-300">You prefer the <strong class="text-white">simplest possible setup</strong></span>
                            </li>
                            <li class="flex items-start">
                                <svg class="w-5 h-5 text-cyan-400 mt-0.5 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                </svg>
                                <span class="text-slate-300">You don't need Google/Alexa voice integration</span>
                            </li>
                        </ul>
                        <div class="mt-8 pt-6 border-t border-white/10">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="space-y-4">
                <details class="group bg-white/5 backdrop-blur-lg rounded-2xl border border-white/10 overflow-hidden">
                    ...
                    <div class="px-6 pb-5">
                        <p class="text-slate-400">Yes, HARelay is completely free to use. There are no hidden fees, no premium tiers, and no credit card required.</p>
                    </div>
                </details>

                <details class="group bg-white/5 backdrop-blur-lg rounded-2xl border border-white/10 overflow-hidden">
                    <summary class="flex items-center justify-between px-6 py-5 cursor-pointer list-none">
                        <h3 class="text-lg font-semibold text-white">Can I switch from Nabu Casa to HARelay?</h3>
                        <svg class="w-5 h-5 text-slate-400 group-open:rotate-180 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                        </svg>
                    </summary>
                ...
                <details class="group bg-white/5 backdrop-blur-lg rounded-2xl border border-white/10 overflow-hidden">
                    <summary class="flex items-center justify-between px-6 py-5 cursor-pointer list-none">
                        <h3 class="text-lg font-semibold text-white">Is HARelay as secure as Nabu Casa?</h3>
                        <svg class="w-5 h-5 text-slate-400 group-open:rotate-180 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                        </svg>
                    </summary>
                    <div class="px-6 pb-5">
                        <p class="text-slate-400">Both services use encrypted connections and don't require port forwarding. HARelay uses WebSocket tunneling with TLS encryption, similar to how Nabu Casa works.</p>
                    </div>
                </details>

                <details class="group bg-white/5 backdrop-blur-lg rounded-2xl border border-white/10 overflow-hidden">
                    <summary class="flex items-center justify-between px-6 py-5 cursor-pointer list-none">
                        <h3 class="text-lg font-semibold text-white">Why is HARelay free if Nabu Casa costs money?</h3>
                        <svg class="w-5 h-5 text-slate-400 group-open:rotate-180 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                        </svg>
                    </summary>
                    <div class="px-6 pb-5">
                        <p class="text-slate-400">Nabu Casa funds Home Assistant development and provides additional services like voice assistant integration. HARelay focuses only on remote access with minimal infrastructure costs, allowing us to offer it for free.</p>
                    </div>
                </details>
            </div>
        </div>
