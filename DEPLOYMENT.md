...
server {
    ...
    # Browser WebSocket proxy - legacy path
    location /wss {
    ...
    # Home Assistant WebSocket API (transparent proxy for HA frontend)
    # IMPORTANT: Cookie header is required for session authentication
